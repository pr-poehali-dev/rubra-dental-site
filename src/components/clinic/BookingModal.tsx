...
const doctors = [
  { name: "Морозова Елена Сергеевна", specialty: "Терапевт, кардиолог" },
  { name: "Петров Андрей Викторович", specialty: "Невролог" },
  { name: "Белова Ольга Николаевна", specialty: "Офтальмолог" },
  { name: "Козлов Дмитрий Александрович", specialty: "Ортопед, хирург" },
  { name: "Соколова Мария Ивановна", specialty: "Эндокринолог" },
  { name: "Новиков Игорь Петрович", specialty: "Гастроэнтеролог" },
];
