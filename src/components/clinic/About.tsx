        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-foreground/70 leading-relaxed mb-4">
              Рубра — это современная стоматологическая клиника, основанная в 2009 году. За эти годы мы помогли более чем 30 000 пациентам вернуть красоту и здоровье зубов.
            </p>
