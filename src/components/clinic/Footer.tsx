      ...
      <div className="container">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-cormorant text-lg font-bold text-white tracking-wider">РУБРА</span>
          </div>
          <p className="text-sm text-center">© 2024 Стоматология «РУБРА». Лицензия № ЛО-77-01-020123</p>
